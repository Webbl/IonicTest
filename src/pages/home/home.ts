...
export class HomePage implements OnInit {
  ...
  menuData = [
    ...
    { title:'Account', pic:'assets/imgs/logo.png', pushPage: 'AccountPage'},
    { title:'About Us', pic:'assets/imgs/logo.png', pushPage: 'AboutPage'},
    { title:'Locations', pic:'assets/imgs/logo.png', pushPage: 'LocationPage'}
  ];
